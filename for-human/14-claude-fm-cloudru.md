...
> OpenAI-формат. **Проверено живьём 2026-07-24: теперь есть и Anthropic-формат** → всё проще.
>
> ⚠️ **Честная оговорка:** этот Anthropic-эндпоинт **работает, но в официальной документации
> Cloud.ru его нет** — там описан только OpenAI-формат. То есть он проверен эмпирически, но
> недокументирован: Cloud.ru может его убрать без предупреждения, официальной поддержки нет. Если
> вдруг перестанет работать (404) — вернись к пути через LiteLLM ([02](02-claude-code-cloudru.md)).
