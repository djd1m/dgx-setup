...
Пометки NOT VERIFIED (gateway по умолчанию? тег? модель через `.env`?) и команды сверки с живым
образом — в шапке файла. Не выдавать за гарантированно рабочий, пока не сверено с образом.
