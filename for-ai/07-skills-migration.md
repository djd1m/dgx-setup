...
Формат навыка у всех шести одинаков: папка с `SKILL.md`, внутри YAML-frontmatter и markdown-тело.
Hermes и OpenClaw заявляют соответствие [agentskills.io](https://agentskills.io/specification).
Perplexity использует ту же структуру — [research-статья](https://research.perplexity.ai/articles/designing-refining-and-maintaining-agent-skills-at-perplexity):
