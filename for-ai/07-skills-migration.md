...
> **NOT VERIFIED — граница вывода, не нарушать её в разговоре с человеком.**
> Отсутствие **API** доказано (исчерпывающий индекс). А вот **кнопки в интерфейсе** —
> это «не найдено», а **не** «доказано, что нет»: меню навыка у залогиненного пользователя
> проверить не удалось, `www.perplexity.ai` отдаёт **Cloudflare 403** любому
> не-браузерному клиенту.
>
> Практическое следствие: **предложи человеку открыть свой навык и посмотреть самому** —
> он залогинен, а ты нет. Если кнопка есть, Шаг 1 становится тривиальным. Не заявляй
> «выгрузки не существует» как установленный факт.
...
Целевые агенты установлены по инструкциям [01](01-claude-code-local.md),
[03](03-nemoclaw.md), [04](04-hermes.md),
[05](05-ouroboros.md), [06](06-openclaw.md). Ставить навык в
